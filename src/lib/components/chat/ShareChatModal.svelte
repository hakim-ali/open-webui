<script lang="ts">
	...
	import { models, config, theme } from '$lib/stores';
				...
				<div class="flex justify-end">
					<div class="flex flex-col items-end space-x-1 mt-3">
						<div class="flex gap-1">
							<button
								class="self-center flex items-center gap-1 px-3.5 py-2 text-sm font-medium bg-primary-400 hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-gray-100 transition rounded-lg"
								type="button"
