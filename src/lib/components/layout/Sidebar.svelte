  ...
  "
	>
		<div class="sidebar__top h-[calc(100vh-58px)] overflow-y-auto ">
			...
			<div class="w-[300px] left-0 absolute bottom-[50px] h-[108px]  flex justify-center items-center bg-[linear-gradient(180deg,_rgba(255,255,255,0)_0%,_#FFF_100%)]">
					<button on:click={scrollToTop} class="w-[32px] h-[32px] border border-[#DEE0E3] rounded-full flex items-center justify-center">
