...
class DoclingLoader:
    ...
    def load(self) -> list[Document]:
        ...
        with open(self.file_path, "rb") as f:
            ...
            params = {"image_export_mode": "placeholder", "table_mode": "fast", "to_formats": "md", "pdf_backend": "pypdfium2", "pipeline": "standard", "do_table_structure": True, "include_images": False}
